...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--arch', type=str, default='CLIP:ViT-L/14@336px', help='see my_models/__init__.py')
        ...
        parser.add_argument('--data_path',default=None, help='path to the dataset')
        ...
        parser.add_argument('--data_mode',  default='ffpp', help='wang2020 or ours')
        ...
        #parser.add_argument('--method',default='all', help='deepfake methods for train')

        parser.add_argument('--data_root', type=str, default='datasets/FF++/', help='Path to the FF++ dataset root directory')
        parser.add_argument('--fake_types', nargs='+', default=['Deepfakes', 'Face2Face','FaceSwap','FaceShifter','NeuralTextures','DeepFakeDetection'], help='Types of fake images to include')
        parser.add_argument('--class_bal', action='store_true') # class_balance
        #parser.add_argument('--no_resize', action='store_true', help='Disable resizing of the images')
        parser.add_argument('--batch_size', type=int, default=8, help='input batch size')
        parser.add_argument('--loadSize', type=int, default=336, help='scale images to this size')#256
        parser.add_argument('--cropSize', type=int, default=336, help='then crop to this size')#224
