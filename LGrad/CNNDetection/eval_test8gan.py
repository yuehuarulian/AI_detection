...
# python ./CNNDetection/eval_test8gan.py --model_path ./CNNDetection/checkpoints/5class-resnet2024_09_06_01_05_31\model_epoch_last.pth  --dataroot /Grad_data_paper/test --batch_size 16 --gpu_id=0
def main():
  # vals = ['deepfake','face']
  vals = ['Grad_testdata']
  ...
  for v_id, val in enumerate(vals):
      ...
      result_file = os.path.join(dataroot, 'cla_pre.csv')
      with open(result_file, mode='w', newline='') as file:
        ...
        for i in range(len(labels)):
          ...
          writer.writerow([img_name.split('.')[0], int(label)])  # 将布尔值转换为0或1
